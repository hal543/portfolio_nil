...
<div class ="sub_header">
	...
	<div class="info-middle">
		...
		<div class="lbn_main">
			<div class="fav_lbn">
				<h2><?= ($_SESSION['user_all']["user_name"]);?>さんのお探しの生体</h2>
						<div class="showlbn1">
                            ...
                            <?php if ($favLbne['soldout'] == '1') :?>
                                <a href ="../user_lbn_details/user_lbn_details.php?lbn_id=<?="{$favLbn['lbn_id']}"; ?>">             
                                    <div class="sold_out_ust-show">
                                    <div class="sold_out_border">
                                        <img src ="<?= "{$favLbn['file_path']}"; ?>" ,alt= "" class="sold_out_ust-showpic">
                                    </div>
                                    </div>
                            </div>
                                </a>
							<?php else: ?>
							        <a href ="../user_lbn_details/user_lbn_details.php?lbn_id=<?="{$favLbn['lbn_id']}"; ?>">
                                        <div class="ust-show">
                                            <img src ="<?= "{$favLbn['file_path']}"; ?>" ,alt= "" class="ust-showpic">
                                        </div>
                                    </a>
                            <?php endif ?>
						<?php endforeach?>
			...
			<div>
				<p class="ust_all_lbn_title">全ての新着生体情報</p>
                <div class="ust_all_lbn">
					<div class="ust_showlbn">
						<?php foreach($files as $file): ?>
                            <?php if ($file['soldout'] == '1') :?>
                                <a href ="../user_lbn_details/user_lbn_details.php?lbn_id=<?="{$file['lbn_id']}"; ?>">             
                                    <div class="sold_out_ust-show">
                                    <div class="sold_out_border">
                                        <img src ="<?= "{$file['file_path']}"; ?>" ,alt= "" class="sold_out_ust-showpic">
                                    </div>
                                    </div>
                            </div>
                                </a>
							<?php else: ?>
							        <a href ="../user_lbn_details/user_lbn_details.php?lbn_id=<?="{$file['lbn_id']}"; ?>">
                                        <div class="ust-show">
                                            <img src ="<?= "{$file['file_path']}"; ?>" ,alt= "" class="ust-showpic">
                                        </div>
                                    </a>
                            <?php endif ?>
						<?php endforeach?>
				
					<div class="ust-moreButton">
						<a href="user_newLbn_all.php"><button class="ust-more-button" type="button">
							もっと見る
						</a></button>
					</div>
                <div>
...
<div class="footer">
	...
	<div class="footer-menu">
        <span><a href="../user_top/user_top.php">TOP</a></span>
        <span><a href="../../user/user_info/user_info.php">お知らせ</a></span>
        <span><a href="../user_form/user_form.php">お問い合わせ</a></span>
        <span><a href="../user_common/user_privacy.php">個人情報保護方針</a></span>
        <span><a href="../user_commmon/administrator.php">運営者</span>
      </div>
