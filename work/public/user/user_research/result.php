...
$search_name= filter_input(INPUT_POST,'lbn_result',FILTER_SANITIZE_SPECIAL_CHARS);

define('MAX','20');
$files = searchResult($search_name);
...
<div class="una_main">
        ...
        <div>
            <p class="result_all">全件数&ensp;:&ensp;<?=$files_num ?>件</p>
        </div>
