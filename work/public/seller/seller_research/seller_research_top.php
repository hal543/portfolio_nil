...
$select_lbn_name=$_GET['name'];
$select_lbn_name=htmlspecialchars("$select_lbn_name", ENT_QUOTES, 'UTF-8');

define('MAX','20');
$files = GetLbnSeller($select_lbn_name);
...
?>
            <span class="st-header-title"><?=$select_lbn_name?>の投稿<span>
