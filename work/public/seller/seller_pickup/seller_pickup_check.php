...
<?php if( $lbn_name ==='' || $morph==='' || $filesize > 1048576 || preg_match('/\A[0-9]+\z/',$price)==0 || $lbn_pic==='' || !in_array(strtolower($file_ext),$allow_ext)): ?>
    <div>
		<form>
...
<div class= "tc_middle">
	...
	<form method="post" action="seller_pickup_done.php" enctype="multipart/form-data">
